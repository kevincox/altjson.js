...
tests.forEach(function(t) {
	...
	tfweb += '<script src="https://rawgit.com/kevincox/altjson.js/master/test/'+t+'"></script>\n';
});
html    = html.replace(/\{\{\{tests\}\}\}/g, tf);
htmlweb = htmlweb.replace(/\{\{\{tests\}\}\}/g, tfweb);

fs.writeFileSync("test.html", html.replace(/\{\{\{url\}\}\}/g, "altjson.js"));
fs.writeFileSync("test.min.html", html.replace(/\{\{\{url\}\}\}/g, "altjson.min.js"));
fs.writeFileSync("test.web.html", htmlweb.replace(/\{\{\{url\}\}\}/g, "https://rawgithub.com/kevincox/altjson.js/master/altjson.js"));
